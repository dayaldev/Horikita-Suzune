...
ANIME_HANDLER = CommandHandler("animee", anime)
CHARACTER_HANDLER = CommandHandler("characterr", character)
MANGA_HANDLER = CommandHandler("mangaa", manga)
